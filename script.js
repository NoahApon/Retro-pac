...
let ghostOne = document.getElementById("ghostOne");
let ghostTwo = document.getElementById("ghostTwo");
let ghostThree = document.getElementById("ghostThree");
let pacOne = document.getElementById("pacmanone");
let pacTwo = document.getElementById("pacmantwo");
let pacimg = pacOne;
...
ctx.font = "45px thunderstrom";
ctx.fillText("RETRO SUNSET", 635, 150);
ctx.fillStyle = "rgb(255,0,255)";
ctx.font = "44.8px thunderstrom";
ctx.fillText("RETRO SUNSET", titleSlide, 150);

//Pacman

//Ghosts
ctx.drawImage(ghostOne, ghostOneX, levelY, 95, 60);
ctx.drawImage(ghostTwo, ghostTwoX, levelY, 70, 60);
ctx.drawImage(ghostThree, ghostThreeX, levelY, 75, 60);
ctx.drawImage(pacimg, pacX, levelY, 50, 50);

//animations
sunGlow1 += glowSpeed;
sunGlow2 += glowSpeed;
sunGlow3 += glowSpeed;
titleSlide += titleSlideSpeed;
...
ghostOneX += 8;
ghostTwoX = ghostOneX - 50;
ghostThreeX = ghostTwoX - 70;
pacX = ghostOneX + 90;
if (ghostOneX >= 1100 && loop == 0) {
  ghostOneX = -100;
  levelY = 480;
  loop = 1;
} else if (ghostOneX >= 1100 && loop == 1) {
    ghostOneX = -100;
  levelY = 610;
  loop = 2;
} else if (ghostOneX >= 1100 && loop == 2) {
    ghostOneX = -100;
  levelY = 390;
  loop = 0;
}
...
pacFrame ++;
if (pacFrame >= 0 && pacFrame < 20) {
  pacimg = pacOne;
} else if (pacFrame >= 20 && pacFrame < 40) {
  pacimg = pacTwo;
} else if (pacFrame >= 40 && pacFrame < 60) {
  pacimg = pacTwo;
} else if (pacFrame == 60) {
  pacFrame = 0;
}
